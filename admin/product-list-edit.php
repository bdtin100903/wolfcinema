        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" /></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                // Lay du lieu cho nguoi dung nhap
                            
                                $name = $_POST["namef"];
                                $describe = $_POST["describef"];
                                $genre = $_POST["genref"];
                                $cast = $_POST["castf"];
                                $time = $_POST["timef"];
                                $price = $_POST["pricef"];
                                $role_film = $_POST["role_film"];
                                // connect DB
                                $conn = mysqli_connect("localhost", "root", "", "wolfcinema");
                                $sql = "UPDATE danhsachfilm SET namef = '$name', describef='$describe', genref='$genre', 
                                castf='$cast', timef='$time', pricef='$price',role_film='$role_film' WHERE ID=$id";
                                $kq = mysqli_query($conn, $sql);
                                echo '<script>alert("Sửa thành công")</script>';
                            }
                                 //truy vấn
                                 $sql1 = "SELECT * FROM danhsachfilm WHERE id = $id ";
                                 $result1 = mysqli_query($conn, $sql1);
                                 $kq1 = mysqli_fetch_array($result1);
                                 ?>
                                 <form  method="post">
                                  <div>
                                    <tr>     
                                  <td><input name="img"style="color:black;"type="file" value="<?php echo $kq1['img']; ?>"></td>                 
                                  <td><input name="namef"style="color:black;"type="text" value="<?php echo $kq1['namef']; ?>"></td>
                                  <td><input name="describef"style="color:black;"type="text" value="<?php echo $kq1['describef']; ?>"></td>
                                  <td><input name="genref"style="color:black;"type="text" value="<?php echo $kq1['genref']; ?>"></td>
                                  <td><input name="castf"style="color:black;"type="text" value="<?php echo $kq1['castf']; ?>"></td>
                                  <td><input name="timef"style="color:black;"type="text" value="<?php echo $kq1['timef']; ?>"></td>
                                  <td><input name="pricef"style="color:black;"type="text" value="<?php echo $kq1['pricef']; ?>"></td>                                  
                                  <td><input style="color:black;"type="text" value="<?php echo $kq1['linktrailer']; ?>"></td>
                                  <td><input style="color:black;"type="text" value="<?php echo $kq1['role_film']; ?>"></td>
                                  <input id="submit" type="submit" value="Xác Nhận">
                                  </tr>
                                 </div>
                                </form>
