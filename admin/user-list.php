                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <?php
                                 ...
                                 {   
                                    echo '<tr>';                     
                                    echo '<td><p>'. $output['fullname'].'</p></td>';
                                    echo '<td><p>'. $output['phone'].'</p></td>';
                                    echo '<td><p>'. $output['gmail'].'</p></td>';
                                    echo '<td><p>'. $output['username'].'</p></td>';
                                    echo '<td><p>'. $output['password'].'</p></td>';
                                    echo '<td><p>'. $output['role'].'</p></td>';
                                    echo '<td>
                                            <a href="./user-list-edit.php?id='.$output['id'].'">
                                    ...
                                    echo '<td>
                                            <a href="./user-list-delete.php?id='.$output['id'].'">
