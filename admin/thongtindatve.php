                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <?php
                                 //truy vấn
                                 $sql = "SELECT * FROM thongtindatve";
                                 $result = mysqli_query($conn, $sql);
                                 
                                 while ($output = mysqli_fetch_array($result)) {   
                                     echo '<tr>';
                                     echo '<td><p>' . $output['id'] . '</p></td>';
                                     ...
                                     echo '<td>
                                         <form method="post">
                                             <input type="hidden" name="idToUpdate" value="' . $output['id'] . '">
                                             <button type="submit" name="buttonA" style="background-color: green;">Đã thanh toán</button>
                                             <button type="submit" name="buttonB" style="background-color: red;">Chưa thanh toán</button>
                                         </form>
                                     </td>';
                                     echo '</tr>';
                                 }
                                 ...
                                 if (isset($_POST['buttonA'])) {
                                    ...
                                    if (isset($_POST['buttonB'])) {
                                      $idToUpdate = mysqli_real_escape_string($conn, $_POST['idToUpdate'] ?? '');
                                     if (!empty($idToUpdate)) {
                                      $sqlB = "UPDATE thongtindatve SET status = '2' WHERE id = '$idToUpdate'";
