                            ...
                            <table>
                                ...
                                <?php
                                 ...
                                 {   
                                    ...
                                    style="height: 200px;
                                    width: 1000px;" 
                                    src="../Image/img_filmdangchieu/'.$output['img'].'"></a></td>';                     
                                    echo '<td><p>'. $output['namef'].'</p></td>';
                                    echo '<td><p>'. $output['describef'].'</p></td>';
                                    echo '<td><p>'. $output['genref'].'</p></td>';
                                    echo '<td><p>'. $output['castf'].'</p></td>';
                                    echo '<td><p>'. $output['timef'].'</p></td>';
                                    echo '<td><p>'. $output['pricef'].'</p></td>';
                                    echo '<td><p>'. $output['linktrailer'].'</p></td>';
                                    echo '<td><p>'. $output['role_film'].'</p></td>';

                                    echo '<td>
                                            <a href="./product-list-edit.php?id='.$output['id'].'">
                                    ...
                                    echo '<td>
                                            <a href="./product-list-delete.php?id='.$output['id'].'">
                                ...
                                <?php
                                 ...
                                 {   
                                    ...
                                    style="height: 200px;
                                    width: 100px;" 
                                    src="../Image/img_filmsapchieu/'.$output['img'].'"></a></td>';                     
                                    echo '<td><p>'. $output['namef'].'</p></td>';
                                    echo '<td><p>'. $output['describef'].'</p></td>';
                                    echo '<td><p>'. $output['genref'].'</p></td>';
                                    echo '<td><p>'. $output['castf'].'</p></td>';
