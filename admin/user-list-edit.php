                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $pass = $_POST["password"];
                                $role = $_POST["role"];
                                $sql = "UPDATE user SET fullname = '$name', phone='$phone', gmail='$gmail', 
                                ...
                                echo '<script>alert("Sửa thành công")</script>';
                                 ...
                                 <form  method="post">
                                  <div>     
                                  <td><input name="fullname"style="color:black;"type="text" value="<?php echo $kq1['fullname']; ?>"></td>                 
                                  <td><input name="phone"style="color:black;"type="text" value="<?php echo $kq1['phone']; ?>"></td>
                                  <td><input name="gmail"style="color:black;"type="text" value="<?php echo $kq1['gmail']; ?>"></td>
                                  <td><input name="username"style="color:black;"type="text" value="<?php echo $kq1['username']; ?>"></td>
                                  <td><input name="password"style="color:black;"type="text" value="<?php echo $kq1['password']; ?>"></td>
                                  <td><input name="password"style="color:black;"type="text" value="<?php echo $kq1['role']; ?>"></td>
